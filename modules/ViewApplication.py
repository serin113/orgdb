    ...
    def approve(self, application_id):
        ...
        if toInt(apd["hasRecord"]) == 0:
            ...
            addrecord.insert(
                ...
                apd["clubName"], apd["address"], apd["city"], apd["province"],
                apd["adviserName"], apd["contact"], apd["email"], "1", "", "1",
                "", "", apd["schoolYear"], apd["yearsAffiliated"], apd["SCA"],
                apd["SCM"], apd["paymentMode"], apd["paymentDate"],
                apd["paymentID"], apd["paymentAmount"], apd["receiptNumber"],
                apd["paymentSendMode"])
